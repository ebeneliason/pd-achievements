...
2. Edit `_data/games.yml`, copying the commented template and supplying the requisite information for your game. You’ll need to supply the following (**fields are required unless otherwise indicated**):
   ...
   | `catalogUrl`       | `URL?`      | (_optional_) A link to the game listing in the Playdate [Catalog](https://play.date/games). If provided, this link will be used only on or after `releaseDate`, preventing the need to update the `url` field on release day when the Catalog page goes live.                                                                                                                                                                                                                                                                                                                                        |
