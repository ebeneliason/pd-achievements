...
Of course, games may also present their earned achievements themselves. Additionally, the open standard makes it possible for others to create dedicated achievement viewer apps in the future. For example, the [*helloyellow*](https://helloyellow.app) app showcases achievements earned by your friends, and also awards custom emoji for use in chats based on the other games you've played.
